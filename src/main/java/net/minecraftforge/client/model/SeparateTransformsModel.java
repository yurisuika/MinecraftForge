...
public class SeparateTransformsModel implements IUnbakedGeometry<SeparateTransformsModel> {
    ...
    public static class Baked implements IDynamicBakedModel {
        ...
        public Baked(boolean isAmbientOcclusion, boolean isGui3d, boolean isSideLit, TextureAtlasSprite particle, BakedModel baseModel, ImmutableMap<ItemDisplayContext, BakedModel> perspectives) {
